...
#define LED1 11     // GPIO 7  | Output waarschuwings LED links  (LED1)
#define LED2 27     // GPIO 16 | Output waarschuwings LED rechts (LED2)

#define SERV1 5     // GPIO 24 | Output servo (SERV1) (BRIDGE)
#define SERV2 31    // GPIO 1  | Output servo (SERV2) (BARRIER 1)
